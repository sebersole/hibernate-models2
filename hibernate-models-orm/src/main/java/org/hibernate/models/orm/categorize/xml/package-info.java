 ...
 * based on the XML.<ol>
 *     <li>
 *         First performs some {@linkplain org.hibernate.models.orm.categorize.xml.spi.XmlPreProcessor pre-processing}
 *         which aggregates information across all XML mappings
 *     </li>
 *     <li>
 *         Next performs XML {@linkplain org.hibernate.models.orm.categorize.xml.spi.XmlProcessor processing} which
 *         applies metadata-complete mappings and collects overlay/override XML for later application.
 *     </li>
 *     <li>
 *         Performs XML {@linkplain org.hibernate.models.orm.categorize.xml.spi.XmlProcessingResult post-processing} which

...
public class ClassDetailsRegistryImpl implements ClassDetailsRegistry {
	...
	public ClassDetailsRegistryImpl(ClassDetailsBuilder fallbackClassDetailsBuilder, SourceModelBuildingContext context) {
		...
		this.standardClassDetailsBuilder = new StandardClassDetailsBuilder( fallbackClassDetailsBuilder );
	}
	...
	private static class StandardClassDetailsBuilder implements ClassDetailsBuilder {
		...
		public StandardClassDetailsBuilder(ClassDetailsBuilder fallbackClassDetailsBuilder) {

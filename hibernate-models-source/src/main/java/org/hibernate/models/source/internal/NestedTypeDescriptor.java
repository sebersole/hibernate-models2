...
import org.hibernate.models.source.internal.jandex.NestedValueExtractor;
import org.hibernate.models.source.internal.jandex.NestedValueWrapper;
...
public class NestedTypeDescriptor<A extends Annotation> extends AbstractTypeDescriptor<AnnotationUsage<A>> {
	...
	private org.hibernate.models.source.internal.jdk.NestedValueWrapper<A> jdkWrapper;
	private org.hibernate.models.source.internal.jdk.NestedValueExtractor<A> jdkExtractor;
	...
	public org.hibernate.models.source.internal.jdk.NestedValueWrapper<A> resolveJdkWrapper(SourceModelBuildingContext buildingContext) {
		if ( jdkWrapper == null ) {
			jdkWrapper = new org.hibernate.models.source.internal.jdk.NestedValueWrapper<>( resolveDescriptor( buildingContext ) );
		}
		return jdkWrapper;
	}
	...
	public ValueExtractor<Annotation, AnnotationUsage<A>> resolveJdkExtractor(SourceModelBuildingContext buildingContext) {
		if ( jdkExtractor == null ) {
			jdkExtractor = new org.hibernate.models.source.internal.jdk.NestedValueExtractor<>( resolveJdkWrapper( buildingContext ) );
		}
		return jdkExtractor;
	}

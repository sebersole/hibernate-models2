...
public class SessionFactorySettingsResolver {
	 ...
	 */
	public ResolvedSessionFactorySettings resolve(
	...
	private StatementObserver resolveStatementObserver(Map<String, Object> configurationValues) {
	...
	private SessionFactoryObserver[] resolveSessionFactoryObservers(
			Map<String, Object> configurationValues,
			StandardServiceRegistry serviceRegistry) {
	...
	private void addSessionFactoryObservers(
			Object setting,
			StandardServiceRegistry serviceRegistry,

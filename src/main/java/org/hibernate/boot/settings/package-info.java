...
/// exposes frequently used, model-shaping settings as grouped named values while
/// still carrying raw configuration values forward for later bootstrap stages.
///

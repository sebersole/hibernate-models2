...
public class CommonAttributeProcessing {
	...
	public static void applyAccess(
			...
			MutableMemberDetails memberDetails,
			XmlDocumentContext xmlDocumentContext) {
		final MutableAnnotationUsage<Access> accessAnn = makeAnnotation( Access.class, memberDetails, xmlDocumentContext );
	...
	public static <A extends Annotation> void applyAttributeAccessor(
		...
		final MutableAnnotationUsage<AttributeAccessor> accessAnn = makeAnnotation( AttributeAccessor.class, memberDetails, xmlDocumentContext );
	...
	public static <A extends Annotation> void applyOptimisticLock(
		...
		final MutableAnnotationUsage<OptimisticLock> optLockAnn = makeAnnotation( OptimisticLock.class, memberDetails, xmlDocumentContext );
	...
	private static void applyFetchMode(
		...
		if ( jaxbFetchMode != null ) {
			...
			final MutableAnnotationUsage<Fetch> fetchAnn = makeAnnotation( Fetch.class, memberDetails, xmlDocumentContext );
